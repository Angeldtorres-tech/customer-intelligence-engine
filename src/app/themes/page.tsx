...
import { themes, products, feedbackItems } from "@/lib/mock-data";
import type { Theme, FeedbackSource } from "@/lib/mock-data";
import {
  AreaChart,
  Area,
  ResponsiveContainer,
...
export default function ThemesPage() {
  ...
  const filteredThemes = useMemo(() => {
    ...
    return result;
  }, [filterProduct, filterSource, filterClassification, sortKey, sortDir]);
